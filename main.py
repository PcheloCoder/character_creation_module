...
def attack(char_name: str, char_class: str):
    ...
    if char_class == 'healer':
        ...
        return (f'{char_name} не применил атакующие умение')
...
def special(char_name: str, char_class: str):
    """Вычисляет результат применения специально умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str):
    """Выводит текстовое сопровождение тренировки."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Выводит текстовое сопровождение выбора класса персонажа."""
    approve_choice = None
    char_class = None
    while approve_choice != 'y':
        ...
        if char_class == 'warrior':
            print('Воитель — дерзкий вои н ближнего боя. '
